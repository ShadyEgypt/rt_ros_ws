...
(cl:in-package assignment2_p1-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <GetLastTarget-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetLastTarget-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name assignment2_p1-srv:<GetLastTarget-request> is deprecated: use assignment2_p1-srv:GetLastTarget-request instead.")))

(cl:ensure-generic-function 'set_target-val :lambda-list '(m))
(cl:defmethod set_target-val ((m <GetLastTarget-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader assignment2_p1-srv:set_target-val is deprecated.  Use assignment2_p1-srv:set_target instead.")
  (set_target m))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <GetLastTarget-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader assignment2_p1-srv:x-val is deprecated.  Use assignment2_p1-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <GetLastTarget-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader assignment2_p1-srv:y-val is deprecated.  Use assignment2_p1-srv:y instead.")
  (y m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetLastTarget-request>)))
  ...
  "assignment2_p1/GetLastTargetRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetLastTarget-request)))
  "Returns string type for a service object of type 'GetLastTarget-request"
  "assignment2_p1/GetLastTargetRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GetLastTarget-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetLastTarget-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name assignment2_p1-srv:<GetLastTarget-response> is deprecated: use assignment2_p1-srv:GetLastTarget-response instead.")))

(cl:ensure-generic-function 'res_x-val :lambda-list '(m))
(cl:defmethod res_x-val ((m <GetLastTarget-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader assignment2_p1-srv:res_x-val is deprecated.  Use assignment2_p1-srv:res_x instead.")
  (res_x m))

(cl:ensure-generic-function 'res_y-val :lambda-list '(m))
(cl:defmethod res_y-val ((m <GetLastTarget-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader assignment2_p1-srv:res_y-val is deprecated.  Use assignment2_p1-srv:res_y instead.")
  (res_y m))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <GetLastTarget-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader assignment2_p1-srv:success-val is deprecated.  Use assignment2_p1-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetLastTarget-response>)))
  ...
  "assignment2_p1/GetLastTargetResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetLastTarget-response)))
  "Returns string type for a service object of type 'GetLastTarget-response"
  "assignment2_p1/GetLastTargetResponse")
